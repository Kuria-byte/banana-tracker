...
function taskDbToModel(dbTask: any): Task {
  return {
    ...
    plotId: dbTask.plotId?.toString() ?? undefined,
    ...
    createdAt: dbTask.createdAt ? dbTask.createdAt.toISOString() : undefined,
    updatedAt: dbTask.updatedAt ? dbTask.updatedAt.toISOString() : undefined,
